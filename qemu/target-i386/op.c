...
void OPPROTO op_read_mdbg_level(void)
{
  mdbg_level = PARAM1;
  helper_read_mdbg_level();
}

void OPPROTO op_set_mem_monitor(void)
{
  helper_set_mem_monitor(PARAM1, PARAM2);
}

void OPPROTO op_reset_mem_monitor(void)
{
  helper_reset_mem_monitor(PARAM1, PARAM2);
}

void OPPROTO op_print_eip(void)
{
  helper_print_eip(PARAM1);
}

void OPPROTO op_print_state(void)
{
  helper_print_state(PARAM1);
}

void OPPROTO op_inspect_memory(void)
{
  helper_inspect_memory(PARAM1, PARAM2);
}

void OPPROTO op_memory_monitor(void)
{
  helper_memory_monitor(PARAM1);
}

void OPPROTO op_count_executions(void)
{
  target_ulong eip = (uint32_t)PARAM1;
  profile_log_increment_count(eip);
}

void OPPROTO op_check_stack_pointers(void)
{
  helper_check_stack_pointers();
}

void OPPROTO op_temporary_check(void)
{
  helper_temporary_check(PARAM1);
}

void OPPROTO op_check_breakpoint(void)
{
  target_ulong new_eip;
  new_eip = (uint32_t)PARAM1;
  helper_check_breakpoint(new_eip);
}

void OPPROTO op_print_memaccess(void)
{
  int base, index, scale, seg;
  ...
  seg = (seg == 7)?-1:seg;
  base = (base == 0x1f)?-1:base;
  index = (index == 0x1f)?-1:index;

  helper_print_memaccess(seg, base, scale, index,
      ((target_ulong)PARAM2 << 32) | (target_ulong)PARAM3);
}

void OPPROTO op_print_errormsg(void)
{
  helper_print_errormsg();
}

void OPPROTO op_profile_reset(void)
{
  helper_profile_reset();
}

void OPPROTO op_romwrite_set_dst(void)
{
  helper_romwrite_set_dst(PARAM1);
}

void OPPROTO op_romwrite_set_src(void)
{
  helper_romwrite_set_src(PARAM1);
}

void OPPROTO op_romwrite_set_size(void)
{
  helper_romwrite_set_size(PARAM1);
}

void OPPROTO op_romwrite_transfer(void)
{
  helper_romwrite_transfer();
}

void OPPROTO op_dec_n_exec(void)
{
  env->n_exec--;
}
